...
func (f *fakeInterventionRepository) SaveWithStatus(_ context.Context, intervention domain.Intervention, _ domain.ServiceOrder, _ domain.StatusTransition) error {
	f.intervention[intervention.ID] = intervention
	return nil
}
