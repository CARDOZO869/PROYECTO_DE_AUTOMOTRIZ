...
func TestAssignAcceptsAFreeTechnicianAndMarksTheAssignmentActive(t *testing.T) {
	...
	if !assignment.IsActive || assignment.ActiveMarker == nil || *assignment.ActiveMarker != "technician-1" || assignment.ActiveOrderMarker == nil || *assignment.ActiveOrderMarker != "order-1" {
