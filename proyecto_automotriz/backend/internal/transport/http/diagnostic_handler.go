...
func NewDiagnosticHandlerWithAccess(diagnostic usecase.DiagnosticUseCase, assignment usecase.AssignmentUseCase, technician usecase.TechnicianUseCase) DiagnosticHandler {
	return DiagnosticHandler{diagnostic: diagnostic, assignment: assignment, technician: technician, accessConfigured: true}
}
