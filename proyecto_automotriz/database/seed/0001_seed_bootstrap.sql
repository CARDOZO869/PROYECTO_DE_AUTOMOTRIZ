...
--   @technician_one_username, @technician_one_password_hash,
--   @technician_one_full_name, @technician_one_specialty,
--   @technician_two_username, @technician_two_password_hash,
--   @technician_two_full_name, @technician_two_specialty
-- The validation runner reads them from .env.example; a real deployment reads
-- them from its own environment. All password hashes are bcrypt with cost 12;
