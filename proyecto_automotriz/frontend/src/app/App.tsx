    ...
    <SessionProvider>
      <BrowserRouter>
        <Routes>
          ...
          >
            <Route path="/dashboard" element={<ProtectedRoute administratorOnly><DashboardPage /></ProtectedRoute>} />
            <Route path="/customers" element={<ProtectedRoute administratorOnly><CustomerPage /></ProtectedRoute>} />
            <Route path="/vehicles" element={<ProtectedRoute administratorOnly><VehiclePage /></ProtectedRoute>} />
            <Route path="/vehicles/:vehicleId/timeline" element={<ProtectedRoute administratorOnly><VehicleTimelinePage /></ProtectedRoute>} />
            <Route path="/technicians" element={<ProtectedRoute administratorOnly><TechnicianPage /></ProtectedRoute>} />
            ...
            <Route path="/warranties" element={<ProtectedRoute administratorOnly><WarrantyPage /></ProtectedRoute>} />
          </Route>
